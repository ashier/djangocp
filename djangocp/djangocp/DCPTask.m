...
@implementation DCPTask

// ----------------------------------------------------
// Synthesize Operations
// ----------------------------------------------------

@synthesize outputData, executablePath, environmentPath;
...
- (id)initTaskWithEnvironmentPath:(NSString *)envPath withExecutablePath:(NSString *)execPath {
    [self cleanup];
...
- (void)initTask {
    DCPTask *operation = [self initTaskWithEnvironmentPath:environmentPath
